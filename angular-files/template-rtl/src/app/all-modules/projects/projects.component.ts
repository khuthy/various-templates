...
import { pageSelection, apiResultFormat, projects } from 'src/app/shared/models/models';
...
//** / pagination variables
  ...
  private getTableData(): void {
    ...
    this.data.getProjects().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: projects, index: number) => {
  ...
  public searchData(value: string): void {
    ...
    this.projects = this.dataSource.filteredData;
  }
