...
import { pageSelection, apiResultFormat, invoicesOverdue } from 'src/app/shared/models/models';
...
export class InvoicesOverdueComponent implements OnInit {
  ...
  public invoicesOverdue: Array<invoicesOverdue> = [];
  dataSource!: MatTableDataSource<invoicesOverdue>;
...
//** / pagination variables
  ...
  private getTableData(): void {
    ...
    this.data.getInvoicesOverdue().subscribe((data: apiResultFormat) => {
      ...
      data.data.map((res: invoicesOverdue, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<invoicesOverdue>(this.invoicesOverdue);
