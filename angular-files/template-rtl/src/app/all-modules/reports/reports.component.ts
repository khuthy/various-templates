...
import { pageSelection, apiResultFormat, reports, reportPreview } from 'src/app/shared/models/models';
...
export class ReportsComponent implements OnInit {
  ...
  public reports: Array<reports> = [];
  public reportPreview: Array<reportPreview>=[]
...
//** / pagination variables
  ...
  private getTableData(): void {
    ...
    this.data.getReports().subscribe((data: apiResultFormat) => {
      ...
      data.data.map((res: reports, index: number) => {
