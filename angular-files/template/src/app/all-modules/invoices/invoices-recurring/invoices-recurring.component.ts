...
import { pageSelection, apiResultFormat, invoicesRecurring } from 'src/app/shared/models/models';
...
export class InvoicesRecurringComponent implements OnInit {
  ...
  public invoicesRecurring: Array<invoicesRecurring> = [];
...
//** / pagination variables
  ...
  private getTableData(): void {
    ...
    this.data.getInvoicesRecurring().subscribe((data: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<invoicesRecurring>(this.invoicesRecurring);
  ...
  public openBox(val: string): void {
    if (this.select_box_open[0] != val) {
      ...
      console.log('selct',this.select_box_open);
