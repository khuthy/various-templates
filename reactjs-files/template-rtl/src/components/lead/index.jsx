...
const Lead =()=> {
    ...
    const data = [
      ...
      const columns = [
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Full Name</div>),
          dataIndex: "name",
          render: (text, record) => (
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Title</div>),
          dataIndex: "title",
          sorter: (a, b) => a.title.length - b.title.length,
        },
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Company</div>),
          dataIndex: "company",
          render: (text, record) => (
            <>{text}</>
            ),
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Email Address</div>),
          dataIndex: "email",
          render: (text, record) => (
            <>{text}</>
            ),
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Lead Status</div>),
          dataIndex: "status",
          render: (text, record) => (
            <label>{text}</label>
            ),
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Lead Created</div>),
          dataIndex: "created",
          render: (text, record) => (
            <>{text}</>
            ),
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Lead Owner</div>),
          dataIndex: "owner",
          render: (text, record) => (
            <>{text}</>
            ),
