  ...
  const handleDateChange1 = (date) => {
    setSelectedDate1(date);
      ...
      const columns = [
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Company Name</div>),
          dataIndex: "company",
          render: (text, record) => (
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Billing Street</div>),
          dataIndex: "billing",
          render: (text, record) => (
            <>{text}</>
            ),
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Billing State</div>),
          dataIndex: "state",
          render: (text, record) => (
            <>{text}</>
            ),
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Billing Country</div>),
          dataIndex: "country",
          render: (text, record) => (
          <>{text}</>
            ),
