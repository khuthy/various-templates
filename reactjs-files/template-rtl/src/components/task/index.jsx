   ...
   const handleDateChange3 = (date) => {
    setSelectedDate3(date);
     ...
     const data= [
      ...
      const columns = [     
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Task Name</div>),
          dataIndex: "name",
          render: (text, record) => (
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Percent Complate Indicator</div>),
          dataIndex: "width",
          render: (text, record) => (
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Responsible User</div>),
          dataIndex: "user",
          render: (text, record) => (
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Due Date</div>),
          dataIndex: "duedate",
          render: (text, record) => (
            <>{text}</>
            ),
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Task Owner</div>),
          dataIndex: "owner",
          render: (text, record) => (
            <>{text}</>
            ),
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Status</div>),
          dataIndex: "status",
          render: (text, record) => (
