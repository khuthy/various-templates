...
const Project = () => {
  ...
  const columns = [
    ...
    {
      title: () => (<div className='ant-table-column-sorters text-start'>Project Name</div>),
    ...
    {
      title: () => (<div className='ant-table-column-sorters text-start'>Project Status</div>),
    ...
    {
      title: () => (<div className='ant-table-column-sorters text-start'>User Responsible</div>),
    ...
    {
      title: () => (<div className='ant-table-column-sorters text-start'>Project Category</div>),
      dataIndex: "category",
      render: (text, record) => (
        <>{text}</>
      ),
    ...
    {
      title: () => (<div className='ant-table-column-sorters text-start'>pipeline</div>),
      render: (text, record) => (
        <>
    ...
    {
      title: () => (<div className='ant-table-column-sorters text-start'>Project Created</div>),
      dataIndex: "created",
      render: (text, record) => (
        <>{text}</>
      ),
