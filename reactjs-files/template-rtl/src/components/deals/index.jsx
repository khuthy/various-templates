    ...
    setSelectedDate2(date);
     ...
     const data= [
      ...
      const columns = [
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Deal Name</div>),
          dataIndex: "dealname",
          render: (text, record) => (
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Forecast Close Date</div>),
        ...
        {
          title: () => (<div className='ant-table-column-sorters text-start'>Deal Value</div>),
          dataIndex: "dealvalue",
          render: (text, record) => (
            <>{text}</>
          ),
