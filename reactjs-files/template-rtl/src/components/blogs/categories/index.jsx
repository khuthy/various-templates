...
const Categories = () => {
  ...
  const columns = [
    {
      title: () => (<div className='ant-table-column-sorters text-start'>#</div>),
      dataIndex: "num",
      render: (text, record) => (
        <>{text}</>
      ),
    ...
    {
      title: () => (<div className='ant-table-column-sorters text-start'>Category Name</div>),
      dataIndex: "Name",
      render: (text, record) => (
        <>{text}</>
      ),
    ...
    {
      title: () => (<div className='ant-table-column-sorters text-start'>Date</div>),
      dataIndex: "Date",
      render: (text, record) => (
        <>{text}</>
      ),
    ...
    {
      title: () => (<div className='ant-table-column-sorters text-start'>Added By</div>),
      dataIndex: "Added",
      render: (text, record) => (
        <>{text}</>
      ),
