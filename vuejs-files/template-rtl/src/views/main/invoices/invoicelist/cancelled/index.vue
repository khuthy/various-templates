							...
							<div class="card card-table"> 
								<div class="card-body p-4">
									<div class="table-responsive">
										<table class="table table-striped table-nowrap custom-table mb-0 datatable" id="invoicecancelled">
...
<script>
    import invoicecancelled from '../../../../../assets/json/invoices/invoicecancelled.json'
